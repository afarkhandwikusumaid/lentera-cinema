  ...
  return (
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        <div>
          <h1 className="text-2xl font-bold font-heading text-gray-900 mb-1">Klien Sekolah</h1>
          <p className="text-sm text-gray-500">Kelola daftar klien berdasarkan tahun proyek</p>
        </div>
