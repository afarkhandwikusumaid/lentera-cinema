  ...
  return (
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        <div>
          <h1 className="text-2xl font-bold font-heading text-gray-900 mb-1">Pengeluaran Operasional (Universal)</h1>
          <p className="text-sm text-gray-500">Catat pengeluaran perusahaan secara umum di luar proyek</p>
        </div>
          ...
          <tbody>
            {expenses.map((expense) => (
              <tr key={expense.id} className="border-b border-gray-50 transition-colors">
                ...
                <td className="p-4 text-gray-500 text-sm">{new Date(expense.expense_date).toLocaleDateString('id-ID')}</td>
