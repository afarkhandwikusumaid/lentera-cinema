      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="max-w-xl w-full bg-bg-surface border border-border rounded-2xl overflow-hidden animate-scaleUp shadow-2xl">
            ...
            {/* Body */}
            <form onSubmit={async (e) => { e.preventDefault(); setIsOpen(false); await showAlert('Jadwal berhasil ditambahkan!'); }} className="p-6 space-y-4 max-h-[85vh] overflow-y-auto bg-bg-surface">
              <div className="space-y-1">
                <label className="text-[10px] font-bold text-text-secondary uppercase tracking-widest block">Nama Klien / Acara</label>
                <input
                  type="text"
                  required
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-[10px] font-bold text-text-secondary uppercase tracking-widest block">Tanggal Acara</label>
                  <input
                    type="date"
                    required
                    className="w-full bg-bg-elevated border border-border rounded-xl py-2.5 px-3 text-xs text-text-primary focus:outline-none focus:border-accent-primary focus:ring-1 focus:ring-accent-primary transition-all"
                ...
                <div className="space-y-1">
                  <label className="text-[10px] font-bold text-text-secondary uppercase tracking-widest block">Lokasi</label>
                  <input
                    type="text"
                    required
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-bold text-text-secondary uppercase tracking-widest block">Tugaskan Tim Lapangan</label>
                <select className="w-full bg-bg-elevated border border-border rounded-xl py-2.5 px-3 text-xs text-text-primary focus:outline-none focus:border-accent-primary focus:ring-1 focus:ring-accent-primary transition-all cursor-pointer">
