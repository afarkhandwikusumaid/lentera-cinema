    ...
    <AdminLayout>
      <div className="p-6 md:p-10 max-w-7xl mx-auto w-full">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          <div>
            <h1 className="text-2xl font-bold font-heading text-gray-900 mb-1">Manajemen Jadwal & Tim</h1>
            <p className="text-sm text-gray-500">Atur jadwal shooting dan tugaskan tim lapangan (Kameramen, Fotografer, dll).</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 bg-white border border-gray-200 rounded-xl p-6">
            ...
            <div className="bg-bg-base border border-gray-200 border-dashed rounded-lg h-96 flex flex-col items-center justify-center text-text-muted">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 h-fit">
            ...
            <div className="space-y-4">
              {['Andi (Videografer)', 'Budi (Fotografer)', 'Citra (Editor)', 'Deni (Pilot Drone)'].map((member, i) => (
                <div key={i} className="flex items-center justify-between p-3 rounded-lg border border-gray-200 bg-bg-base">
            ...
            <form onSubmit={async (e) => { e.preventDefault(); setIsOpen(false); await showAlert('Jadwal berhasil ditambahkan!'); }} className="p-6 space-y-4 max-h-[85vh] overflow-y-auto bg-white">
              ...
              <div className="flex gap-3 pt-4 border-t border-gray-100">
                <button
                  type="button"
                  onClick={() => setIsOpen(false)}
                  className="flex-1 py-2.5 rounded-xl border border-gray-200 text-gray-900 font-bold text-xs hover:bg-gray-50 transition-colors"
                >
                  Batal
                </button>
                <button
