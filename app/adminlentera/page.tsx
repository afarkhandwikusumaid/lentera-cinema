...
export default function AdminLoginPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="max-w-md w-full p-8 rounded-3xl bg-white/80 backdrop-blur-xl border border-gray-200 space-y-8 relative z-10">
        {/* Glow effect */}
        ...
        <div className="text-center space-y-4 relative z-10">
          ...
          <div>
            <h1 className="font-serif font-bold text-3xl tracking-tight text-gray-900 mb-1">
              Lentera <span className="text-[#c29631] italic">Admin</span>
            </h1>
            <p className="text-[11px] uppercase tracking-widest text-gray-500 font-bold">Sistem Panel Internal</p>
          </div>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5 relative z-10">
          ...
          <div className="space-y-2">
            <label htmlFor="username" className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">
              Username
            </label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-white border border-gray-200 rounded-xl py-3 pl-12 pr-4 text-sm text-gray-900 focus:outline-none focus:border-[#e8b84b] focus:ring-1 focus:ring-[#e8b84b] transition-all placeholder:text-gray-400"
        ...
        <div className="p-4 rounded-xl bg-gray-50 border border-gray-100 text-center text-[11px] text-gray-500 relative z-10">
          <p className="font-bold text-gray-700 mb-1">Informasi Kredensial Demo:</p>
          <p>Username: <code className="text-[#c29631] font-mono bg-white px-1.5 py-0.5 rounded border border-gray-200">admin</code> | Password: <code className="text-[#c29631] font-mono bg-white px-1.5 py-0.5 rounded border border-gray-200">admin123</code></p>
        </div>
      </div>
    </main>
  );
