...
export default function ServicePage() {
  const slug = 'dokumentasi-product';
    ...
    <>
      ...
      <section className="pt-32 pb-20 bg-black border-b border-[#2a2a2a] relative overflow-hidden min-h-[60vh] flex flex-col justify-center">
        ...
        <div className="mx-auto max-w-5xl px-6 relative z-10 text-center">
          ...
          <a href="https://wa.me/6285944629716?text=Halo%20Lentera%20Cinema,%20saya%20butuh%20jasa%20Dokumentasi%20Komersil%20untuk%20brand%20saya." target="_blank" rel="noreferrer" 
