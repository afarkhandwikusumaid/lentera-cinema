...
export default function Contact() {
  ...
  const CONTACTS = [
    { icon: <Phone size={14} />, label: 'WhatsApp', value: '+62 812-3456-7890', href: 'https://wa.me/6281234567890' },
    ...
    { icon: <MapPin size={14} />, label: 'Studio', value: 'Cilandak, Jakarta Selatan', href: 'https://maps.google.com' },
  ];
