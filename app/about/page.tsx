      ...
      <section className="py-16 bg-black">
        <div className="mx-auto max-w-md px-4 text-center space-y-5">
          ...
          <div className="flex items-center justify-center gap-3 pt-1">
            <a href="https://wa.me/6285944629716?text=Halo%20Lentera%20Cinema,%20saya%20menghubungi%20dari%20halaman%20Tentang%20Kami.%20Saya%20tertarik%20untuk%20bekerja%20sama." target="_blank" rel="noreferrer" className="px-6 py-2.5 rounded-full bg-[#e8b84b] text-black font-semibold text-sm hover:brightness-105 transition">Booking WhatsApp</a>
...
function WaFab() {
  return (
    <a href="https://wa.me/6285944629716?text=Halo%20Lentera%20Cinema,%20saya%20menghubungi%20dari%20halaman%20Tentang%20Kami.%20Saya%20tertarik%20untuk%20bekerja%20sama." target="_blank" rel="noreferrer"
