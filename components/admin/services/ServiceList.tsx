  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        <div>
          <h1 className="text-2xl font-bold font-heading text-gray-900 mb-1">Manajemen Layanan</h1>
          <p className="text-sm text-gray-500">Kelola kategori utama layanan (Misal: Yearbook, Wedding)</p>
        </div>
        <button 
          ...
          <tbody>
            {services.map(service => (
              <tr key={service.id} className="border-b border-gray-100">
                ...
                <td className="p-4"><span className="text-sm text-gray-500">{service.subtitle || '-'}</span></td>
                <td className="p-4">
                ...
                <td className="p-4">
                  <div className="flex justify-end gap-2">
                    <a 
                      href={`/adminlentera/portfolio/foto?service_id=${service.id}`}
                    ...
                    <button 
                      ...
                      className="flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-bold text-white bg-gray-100 border border-gray-200 rounded-lg transition-colors hover:bg-[#333] hover:border-[#444]"
                    >
                    ...
                    <button 
                      ...
                      title="Edit Layanan"
                      className="p-1.5 text-[#888] bg-gray-100 border border-gray-200 hover:bg-[#333] hover:text-white rounded-lg transition-colors"
                    >
                      <Edit2 size={14} />
                    </button>
                    <button 
