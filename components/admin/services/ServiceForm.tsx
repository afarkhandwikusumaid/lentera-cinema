    ...
    <div className="bg-white p-6 rounded-xl border border-gray-200 mb-8">
      ...
      <form onSubmit={handleSaveService} className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-900 mb-1">Nama Layanan</label>
        ...
        <div>
          <label className="block text-sm font-medium text-gray-900 mb-1">Deskripsi</label>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-900 mb-1">Background Video URL (opsional)</label>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-900 mb-1">Thumbnail Image</label>
        ...
        <div className="flex items-center gap-2">
          ...
          <label htmlFor="isActive" className="text-sm font-medium text-gray-900">Aktifkan Layanan</label>
        </div>
        <div className="flex gap-2 pt-4">
          <button type="submit" className="bg-black text-white px-4 py-2 rounded font-bold">Simpan</button>
          <button type="button" onClick={() => setIsEditing(false)} className="bg-gray-200 text-gray-900 px-4 py-2 rounded font-bold">Batal</button>
        </div>
      </form>
    </div>
  );
